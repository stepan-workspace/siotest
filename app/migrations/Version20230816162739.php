 ...
 */
final class Version20230816162739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE country_tax (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, value INT NOT NULL, rule VARCHAR(255) NOT NULL, INDEX IDX_B5A98CE7F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
